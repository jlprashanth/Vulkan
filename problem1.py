...
print " Likely of belonging to Class 0 is", float(count0)/total
print " Likely of belonging to Class 1 is", float(count1)/total
print " Likely of belonging to Class 2 is", float(count2)/total
print " Likely of belonging to Class 3 is", float(count3)/total
print " Likely of belonging to Class 4 is", float(count4)/total
